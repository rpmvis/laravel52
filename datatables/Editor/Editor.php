...
namespace DataTables\Editor; // ReneVis: this was: "namespace DataTables;". Namespace now resembles directory structure; class can be loaded by Laravel
...
class Editor extends DataTables\Ext {  // ReneVis: this was: class Editor extends Ext {
	/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
	 * Statics
	 */
